...
|---|---|---|
| **Product Owner** | Humano, aguas arriba del intake. No es ninguna especialidad AG-XX | Maximizar el valor del producto; dueño del Product Backlog; arbitra prioridades y exclusiones y las declara en el `SOLUTION-INTAKE` |
