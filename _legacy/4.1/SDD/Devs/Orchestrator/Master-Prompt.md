...
| Product Owner | Rol humano, aguas arriba del intake y fuera de la cadena AG-XX. Conoce el producto, reúne el material que lo define, **arbitra** entre intereses de stakeholders en conflicto y declara las decisiones de producto en el `SOLUTION-INTAKE`: la priorización MoSCoW de §4 y las exclusiones de §9. Es el autor responsable del intake y quien lo aprueba. Ninguna especialidad AG-XX toma esas decisiones por él: si faltan, se aplica el patrón de ambigüedad legítima de §9. No confundir con AG-00 (Product Manager), que opera aguas abajo y formaliza lo ya decidido. |
