...
| `Devs/Rules/03-Rules-UX-UI-DX.md` | §1.4 extendida con la condición de carga y los requisitos sobre `experiencia-de-uso`/`wireframes` de cada extensión, más la frontera aplicación/entorno; §4.3 tres filas de trazabilidad; §4.4 siete anti-patrones; control de cambios. | 1.4 → 1.5 |
...
| Regla 03 → índice / extensiones | Cumple | `03-Rules-UX-UI-DX.md` §1.4 indica cargar cada extensión vía el índice según su condición, y fija los requisitos sobre `experiencia-de-uso` y `wireframes`; §4.3 suma la fila de trazabilidad de cada una. |
