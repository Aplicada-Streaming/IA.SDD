...
- `Marco-Teorico-SDD-v1.0.md` (1.4 → 1.5): §8.8 (la maqueta como instrumento de diseño y de control) y §9.7 (la deriva como separación acumulativa, la línea de base como referente externo falsable y la fundamentación de D9 y de sus umbrales).
